...
import { getError, getStatus, googleSignIn, resetError, userSignUp } from "../../store/UserSlice";
        ...
        <div className="w-full max-w-sm">
            ...
            <Card>
                <form>
                    ...
                    <div className="mb-6">
                        <label className="block text-gray-700 dark:text-neutral-300 text-sm font-bold mb-2" htmlFor="confirmPassword">
                            Confirm Password
                        </label>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className="text-sm">
                            ...
                            <Link className="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800 dark:hover:text-blue-400 ml-1" to="/login">
                                Log In
                            </Link>
                        </span>
